...
export const metadata: Metadata = {
  ...
  description: 'Validate email addresses with 99% accuracy. Get a quality score (0-100), detect disposable emails, catch typos, and verify deliverability. Free tier available.',
  keywords: ['email validation', 'email verifier', 'email checker', 'bulk email validation', 'email quality score', 'deliverability'],
  openGraph: {
    title: 'MailGuard Pro - Email Intelligence Platform',
    description: 'Validate emails with quality scores. Bulk processing, API access, and exports in CSV/JSON/XLSX/PDF.',
  ...
  twitter: {
    ...
    description: 'Quality scores for your email list. Validate 0-100 with actionable recommendations.',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-[var(--container-lg)] mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto">
            ...
            >
              Your email list is{' '}
              <span className="text-[var(--accent)]">lying to you</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card">
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                Beyond valid/invalid — know exactly how deliverable each email is with our proprietary scoring algorithm.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                Upload CSV files up to 100k rows. Process in background with real-time progress and notifications.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                CSV, JSON, XLSX with formatting, or PDF reports. Choose the format that fits your workflow.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[var(--container-lg)] mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-[var(--text-muted)]">
              ...
              <Link href="/api/v1/tools/mx" className="hover:text-[var(--text-primary)]">MX Lookup</Link>
              <Link href="/api/v1/tools/spf" className="hover:text-[var(--text-primary)]">SPF Lookup</Link>
            </div>
