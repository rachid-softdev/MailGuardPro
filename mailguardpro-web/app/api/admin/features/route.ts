// API Route: Admin - List/Update features
// GET  /api/admin/features?page=1&limit=20&sort=key:asc
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await repo.listFeatures(page, limit, sort);
    ...
    loggerApi.error({ err: error }, "Admin list features error");
